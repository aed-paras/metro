    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="page-header">
                <h4>Add Station <small>Current City: {{ $current_city->name }}</small> <a href="{{url('/admin/city')}}" class="btn btn-default btn-sm">Change</a></h4>
            </div>
                ...
                <form action="{{ url('/admin/station') }}" method="POST" role="form" id="editModalForm">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            {{-- <input type="hidden" name="id" id="modal-station-id" required> --}}
